...
func TestProbeReportsListAndWatchIndependently(t *testing.T) {
	...
	got := byResource(Probe(context.Background(), cs.AuthorizationV1(), gvrs(), 4, nil, nil))
...
func TestProbeAsksClusterWide(t *testing.T) {
	...
	Probe(context.Background(), cs.AuthorizationV1(), gvrs()[:1], 1, nil, nil)
...
func TestProbeReturnsOneCapabilityPerGVR(t *testing.T) {
	...
	if got := Probe(context.Background(), cs.AuthorizationV1(), gvrs(), 8, nil, nil); len(got) != 2 {
...
func TestProbeSkipsWatchWhenListIsDenied(t *testing.T) {
	...
	got := Probe(context.Background(), cs.AuthorizationV1(), gvrs()[:1], 1, nil, nil)
